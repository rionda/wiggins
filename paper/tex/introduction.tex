...
possible, before it loses its relevance. There is no benefit in seeing multiple
...
\emph{\ahmad{novelty}} (or relevance) over time (to focus the search on most
...
\begin{itemize*}
	\item We formalize a generic process that describe the creation and
		...
		\ahmad{novelty} of uncaught items at each time step. On the basis of
