...
$\sched^i$'s, $\cost_\theta(\sched^i,\Sample)$, \ahmad{converges extremely fast, after just few iterations}.
...
``gray'' time interval, the labels of the nodes are permuted randomly, \ahmad{to impose great disruptions in the system.} Following that, at
...
\ahmad{Since the cost function is defined asymptotically (and explains the asymptotic behavior of the system in response to a schedule), in  Figure~\ref{figure:changes} we plot the load of the system $L_\theta(t)$ over the time. Based on this experiment, and as shown in Figure~\ref{figure:changes}, after adapting to the new schedule, the effect of the disruption caused by the perturbation disappears immediately.}
...
\begin{figure}
%  \centering
  \subcaptionbox{Enron-Email\label{fig:change:enronEmail}}{\includegraphics[width=0.49\textwidth]{figures/change/enronEmail.pdf}} %\hspace{1em}%
  \subcaptionbox{Brightkite\label{fig:change:brightkite}}{\includegraphics[width=0.49\textwidth]{figures/change/brightkite.pdf}} %\hspace{1em}
%  \subcaptionbox{Epinion\label{fig:change:epinion}}{\includegraphics[width=0.3\textwidth]{figures/change/epinion.pdf}}\\ %\hspace{1em}\\
  \subcaptionbox{webGoogle\label{fig:change:webgoogle}}{\includegraphics[width=0.49\textwidth]{figures/change/webgoogle.pdf}} %\hspace{1em}
  \subcaptionbox{Notredame\label{fig:change:notredame}}{\includegraphics[width=0.49\textwidth]{figures/change/twitter.pdf}} %\hspace{1em}
