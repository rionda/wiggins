...
\begin{figure}
%  \centering
  \subcaptionbox{Enron-Email\label{fig:change:enronEmail}}{\includegraphics[width=0.49\textwidth]{figures/change/enron.pdf}} %\hspace{1em}%
...
%  \subcaptionbox{Epinion\label{fig:change:epinion}}{\includegraphics[width=0.3\textwidth]{figures/change/epinion.pdf}}\\ %\hspace{1em}\\
  \subcaptionbox{webGoogle\label{fig:change:google}}{\includegraphics[width=0.49\textwidth]{figures/change/google.pdf}} %\hspace{1em}
  \subcaptionbox{Notredame\label{fig:change:notredame}}{\includegraphics[width=0.49\textwidth]{figures/change/notredame.pdf}} %\hspace{1em}
